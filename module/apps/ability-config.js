...
export default class ActorAbilityConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["cnc"],
      template: "systems/cnc/templates/apps/ability-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.format("CNC.AbilityConfigureTitle", {ability: CONFIG.CNC.abilities[this._abilityId]})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    return {
      ...
      labelSaves: game.i18n.format("CNC.AbilitySaveConfigure", {ability: CONFIG.CNC.abilities[this._abilityId]}),
      labelChecks: game.i18n.format("CNC.AbilityCheckConfigure", {ability: CONFIG.CNC.abilities[this._abilityId]}),
      abilityId: this._abilityId,
      proficiencyLevels: {
        0: CONFIG.CNC.proficiencyLevels[0],
        1: CONFIG.CNC.proficiencyLevels[1]
      },
