...
export class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/cnc/templates/advancement/advancement-confirmation-dialog.html",
      jQuery: false
    });
  }
   ...
   * @param {ItemCnc} item  Item to be deleted.
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("CNC.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("CNC.AdvancementDeleteConfirmationMessage"),
      {
   ...
   * @param {ItemCnc} item  The class whose level is being changed.
   * @returns {Promise<boolean|null>}  Resolves with whether advancements should be unapplied. Rejects with null.
   */
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("CNC.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("CNC.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("CNC.LevelActionDecrease")
      }
    );
  }
   ...
   * @param {ItemCnc} item              Item to be changed.
