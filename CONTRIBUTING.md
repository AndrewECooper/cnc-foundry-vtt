# Contributing to Castles & Crusades VTT

Code and content contributions are welcome. Please feel free to submit issues to the issue tracker or submit merge requests for code/content changes. Approval for such requests involves code and possible design review by the maintainers of this repo.
...
All Content released with this system must come from the Troll Lord Games [Players Handbook](https://www.trolllord.com/indexnew.html#works) (aka PHB).
...
Non-English languages are not contained within the core Castles & Crusades system, but instead they are managed by specialized [localization modules](https://foundryvtt.com/packages/tag/translation).
...
```text
https://gitlab.com/troll-lord/foundry-vtt/ruleset/castles-and-crusades/-/releases/release-1.4.3/downloads/-release-1.4.3.zip
                                              └─ Tag Name ──┘               └─ Tag Name ──┘
```
