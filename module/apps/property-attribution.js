...
export default class PropertyAttribution extends Application {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["cnc", "property-attribution"],
      template: "systems/cnc/templates/apps/property-attribution.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  getPropertyLabel(property) {
    ...
    if ( parts[0] === "abilities" && parts[1] ) {
      return CONFIG.CNC.abilities[parts[1]] ?? property;
    } else if ( (property === "attributes.ac.dex") && CONFIG.CNC.abilities.dex ) {
      return CONFIG.CNC.abilities.dex;
    } else if ( (parts[0] === "prof") || (property === "attributes.prof") ) {
      return game.i18n.localize("CNC.Proficiency");
    }
    return property;
  }
}
