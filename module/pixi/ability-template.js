...
/**
 * A helper class for building MeasuredTemplates for CNC spells and abilities
  ...
  static fromItem(item) {
    ...
    switch ( templateShape ) {
      case "cone":
        ...
        break;
      case "rect": // CNC rectangular AoEs are always cubes
        templateData.distance = Math.hypot(target.value, target.value);
        templateData.width = target.value;
        templateData.direction = 45;
        break;
      case "ray": // CNC rays are most commonly 1 square (5 ft) in width
