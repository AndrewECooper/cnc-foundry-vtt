...
export default class ActorArmorConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["cnc", "actor-armor-config"],
      template: "systems/cnc/templates/apps/actor-armor.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("CNC.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac: ac,
      calculations: CONFIG.CNC.armorClasses,
  ...
  async _onChangeInput(event) {
    ...
    const cfg = CONFIG.CNC.armorClasses[calc];
